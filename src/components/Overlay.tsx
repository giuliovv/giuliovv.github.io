            ...
            <div className={clsx(
                ...
                {activeStop && (
                    <div className="flex flex-col items-end">
                        ...
                        {/* Card Content */}
                        <div className={clsx(
                            "bg-black/80 backdrop-blur-md border-l-4 border-cyan-500 p-6 text-white shadow-2xl shadow-cyan-900/20 w-full transition-all duration-300",
                            !isDesktop && !isExpanded ? "opacity-0 h-0 overflow-hidden p-0 border-0" : "opacity-100"
                        )}>
